...
public class TopicHeader implements ITopicHeaderView {
    ...
    public void updateViews(@Nullable Topic topic, boolean isCollect, int replyCount) {
        ...
        if (topic != null) {
            ...
            tvCreateTime.setText(activity.getString(R.string._val_s_create, FormatUtils.getRelativeTimeSpanString(topic.getCreateAt())));
            tvVisitCount.setText(activity.getString(R.string._val_d_count_visit, topic.getVisitCount()));
    ...
    public void updateReplyCount(int replyCount) {
        ...
        tvReplyCount.setText(activity.getString(R.string._val_d_count_reply, replyCount));
    }
