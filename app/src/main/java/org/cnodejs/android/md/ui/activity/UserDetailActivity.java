...
public class UserDetailActivity extends StatusBarActivity implements IUserDetailView, Toolbar.OnMenuItemClickListener {
    ...
    public void onGetUserOk(@NonNull User user) {
        ...
        tvCreateTime.setText(getString(R.string.register_time__val_s, user.getCreateAt().toString("yyyy-MM-dd")));
        tvScore.setText(getString(R.string.score__val_d, user.getScore()));
        adapter.update(user);
